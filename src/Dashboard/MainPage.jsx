    ...
    <section className=''>
        ...
        <div className='block md:hidden  '>
            ...
            <div onClick={handleNav} className="block md:hidden" >
                {
                    nav? <AiOutlineClose className='text-white text-xl font-bold'/> :
                        ...
                        SidebarData.map((item, index) => {
                            return(
                                <div key={index} className="">
                                    <NavLink to={item.path} className="flex justify-start items-center text-lg font-bold pl-4  h-full w-full gap-x-2 space-x-1 space-y-4 py-6 bg-white text-deepPurple" > 
